      ...
      case 1:
        return (
          <View style={styles.stepContainer}>
            <Text style={styles.title}>{t('basic_details')}</Text>
            <TextInput
              style={styles.input}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        <AppButton title={step === 4 ? t('complete_profile') : t('continue')} onPress={handleNext} loading={loading} disabled={(step === 1 && (!fullName || !phone)) || (step === 2 && (!trade || !experience)) || (step === 4 && !workPreference)} />
      </View>
    </SafeAreaView>
  );
};
